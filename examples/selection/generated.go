...
func (ec *executionContext) _Query_events(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalOEvent2ᚕgithubᚗcomᚋsamlitowitzᚋgraphqlcᚑgenᚑgqlgenᚋexamplesᚋselectionᚐEvent(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNEvent2githubᚗcomᚋsamlitowitzᚋgraphqlcᚑgenᚑgqlgenᚋexamplesᚋselectionᚐEvent(ctx context.Context, sel ast.SelectionSet, v Event) graphql.Marshaler {
...
func (ec *executionContext) marshalOEvent2ᚕgithubᚗcomᚋsamlitowitzᚋgraphqlcᚑgenᚑgqlgenᚋexamplesᚋselectionᚐEvent(ctx context.Context, sel ast.SelectionSet, v []Event) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNEvent2githubᚗcomᚋsamlitowitzᚋgraphqlcᚑgenᚑgqlgenᚋexamplesᚋselectionᚐEvent(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
